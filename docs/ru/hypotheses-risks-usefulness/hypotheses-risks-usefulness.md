...
Работа Xie et al. рассматривает многоагентное взаимодействие именно как направленный граф зависимостей и показывает, что локальная ошибка может усиливаться по мере распространения между участниками, а структура взаимодействия существенно влияет на итоговый масштаб отказа [342].
...
Исследование Kostka и Chudziak показывает близкую проблему при многоагентной проверке фактов: согласие между агентами способно создавать ложную уверенность при коррелированных ошибках [343].
...
Книга Albada также подчёркивает, что добавление новых агентов одновременно создаёт дополнительную стоимость связи, координации и ресурсов и рекомендует принцип минимально достаточного числа участников [339].
...
Третья угроза возникает при измерении независимости проверки. Два разных агента могут выглядеть независимыми организационно, но использовать одну модель, один контекст и одну ошибочную предпосылку. В таком случае их ошибки могут оставаться сильно коррелированными [343].
...
Наконец, успешность конкретной многоагентной схемы не следует автоматически переносить на другие классы задач. Исследования многоагентных систем показывают значительную зависимость результата от структуры взаимодействия, постановки и механизма проверки [21], [341], [342].
